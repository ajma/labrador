        ...
        <div className="flex items-center gap-2">
          {showPruneConfirm ? (
            ...
            <button
              ...
              className="rounded-xl border border-white/[0.20] px-3 py-1.5 text-sm text-muted-foreground transition-colors hover:border-white/[0.28] hover:text-foreground"
            >
              Prune Unused
            </button>
          )}
